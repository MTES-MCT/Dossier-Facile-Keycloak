<#assign APP_MAIN_URL="https://www.dossierfacile.fr">
<#assign APP_DOCS_URL="https://docs.dossierfacile.fr">
        ...
        <div class="fr-footer__brand">
          ...
          <a class="beta-logo" href="https://beta.gouv.fr/">
            <img
              ...
              class="footer-logo"
              src="${url.resourcesPath}/img/logo-betagouvfr.svg"
            />
          </a>
        </div>
      ...
      <div class="fr-footer__bottom">
        <ul class="fr-footer__bottom-list">
          ...
          <li class="fr-footer__bottom-item">
            <a
              class="fr-footer__bottom-link"
              href="${APP_MAIN_URL}/mentions-legales"
            >
              ${msg("footer.legals") }
            </a>
          </li>
          <li class="fr-footer__bottom-item">
            <a
              class="fr-footer__bottom-link"
              href="${APP_MAIN_URL}/information"
            >
              ${msg("footer.information") }
            </a>
          </li>
          <li class="fr-footer__bottom-item">
            <a
              class="fr-footer__bottom-link"
              href="${APP_MAIN_URL}/stats"
            >
