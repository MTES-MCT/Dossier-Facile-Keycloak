...
<html xmlns="http://www.w3.org/1999/xhtml" class="${properties.kcHtmlClass!}" lang="fr" data-fr-scheme="light">
...
<head>
    ...
    <link rel="stylesheet" href="${url.resourcesPath}/css/global.css?t=2022080201">
